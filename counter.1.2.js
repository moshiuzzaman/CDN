...
<div class="counter_content">
  ...
  <div class="counter_wrapper">
    <div class="counter_digit">
      <div id="counter_days_2" class="counter_label">
    ...
    <div class="counter_digit">
      <div id="counter_hours_2" class="counter_label">
        <div class="counter_inner">
          <span>0</span>
        </div>
        <div class="counter_inner">
    ...
    <div class="counter_digit">
      <div id="counter_minutes_2" class="counter_label">
        <div class="counter_inner">
          <span>0</span>
        </div>
        <div class="counter_inner">
    ...
    <div class="counter_digit">
      <div id="counter_seconds_2" class="counter_label">
        <div class="counter_inner">
          <span>0</span>
        </div>
        <div class="counter_inner">
...
div#counter_days_2,div#counter_hours_2,#counter_minutes_2,#counter_seconds_2{
  display: flex;
  font-size: 55px !important;
}
div#counter_days_2 span,div#counter_hours_2 span,#counter_minutes_2 span,#counter_seconds_2 span{
...
function timer() {
  ...
  const timeToDisplay = {
    days: num2 / 1000000000,
    hours: (num2 / 1000000) % 1000,
    minutes: (num2 / 1000) % 1000,
    seconds: num2 % 1000,
  };
...
const dd = document.getElementById("counter_days_2");
const hh = document.getElementById("counter_hours_2");
const mm = document.getElementById("counter_minutes_2");
const ss = document.getElementById("counter_seconds_2");
