...
>
    ...
    <div class="cost_Estimation_form_button">
        ...
        <button
            type="button"
            id="cost_Estimation_form_prevButton"
            class="cost_Estimation_submit-button cost_Estimation_secondary-field"
            style="display: none"
        >
            Prev
...
document
    .getElementById("cost_Estimation_form_nextButton")
    .addEventListener("click", async function () {
        ...
        document.getElementById(
            "cost_Estimation_form_prevButton"
        ).style.display = "";
        document.getElementById(
...
document
    .getElementById("cost_Estimation_form_prevButton")
...
p.cost_Estimation_selectedOptionsList_item_label,
#cost_estimation_total {
    margin: 0;
    font-size: 14px;
}

p.cost_Estimation_option-price,
.cost_Estimation_selectedOptionsList_item_price {
    margin: 0;
    font-size: 12px;
    color: gray;
    font-weight: 300;
